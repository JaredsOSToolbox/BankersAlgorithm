//
//  memmgr_final_exam_question.c
//  memmgr
//
// TODO:  IN SHORT, YOU WILL BE ADDING A SECOND TLB (with 64 entries).
//           when you get a new logical address, you will... check TLB1 -->
// TODO: CHECK TLB2 if TLB1_miss then
//           Check Page Table if TLB2_miss, then if Page Table (fault) --> get data and
//           update the page table, then
// TODO:     UPDATE TLB2, then
//           update TLB1, then get the physical address, and compare to correct value...
// TODO:  ADD TLB2 Statistics at end of program, you will need TLB2 variables to track this

// MOST OF LOGIC is IN THIS CODE ALREADY, YOU BASICALLY HAVE TO HANDLE THE TLB2 section
// NOTE: MULTI-LEVEL CACHES are COMMON in OPERATING SYSTEM DESIGN


// NOTE: TODO SECTIONS are NOT marked in the code below
//       but you should be able to find the necessary code from the TLB1 code
//       in this code, TLB1 is called TLB, you don't have to rename TLB to TLB1
//                     for this exam
